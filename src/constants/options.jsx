export const SelectBudgetOptions=[
    {
        ...
        icon: <img src="/trip/cheap.ico" className="h-32 w-50"/>,
    },
    {
        id:2,
        title:'Moderate',
        desc:"Keep cost on the average side",
        icon: <img src="/trip/moderate.ico" className="h-32 w-60"/>,
    },
    {
        id:3,
        title:'Luxury',
        desc:"Don't worry about cost",
        icon: <img src="/trip/luxury.ico" className="h-32 w-60"/>,
    },
]
...
export const SelectTravelList=[
    {
        ...
        icon: <img src="/trip/me.ico" className="h-28 w-50"/>,
        people:'1',
    },
    {
        id:2,
        title:'A couple',
        desc:"Two travelers",
        icon: <img src="/trip/couple.ico" className="h-28 w-50 ml-8"/>,
        people:'2',
    },
    {
        id:3,
        ...
        icon: <img src="/trip/family.ico" className="h-28 w-50 ml-8"/>,
    ...
    },
    {
        ...
        icon: <img src="/trip/friends.ico" className="h-28 w-50 ml-8"/>,
